...
思考ルーチンVer1.02に対し、勝率はおよそ76%程度の強さ。
...
|対戦相手|勝率|
|-|-|
|Thinker V1.02|76%※(Temperature=1.0、1推論あたりのシミュレーション回数=100)|

※毎回同じ手で勝利する傾向があるので､今後はThinker V1.02の方にもランダム性を取り入れて計測することも検討中｡この場合Thinker V1.02が最良手以外を選ぶことになるため､当然Deep版の勝率は上昇する｡
